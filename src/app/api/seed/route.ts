...
const demoUsers = [
  { email: "admin@insurecrm.com", password: "admin123", name: "Alex Johnson", role: "super_admin", team: "AI Operations" },
  { email: "marcus@insurecrm.com", password: "demo123", name: "Marcus Johnson", role: "admin", team: "Support Engineering" },
  { email: "sarah@insurecrm.com", password: "demo123", name: "Sarah Kim", role: "manager", team: "Billing & Accounts" },
  { email: "emily@insurecrm.com", password: "demo123", name: "Emily Rodriguez", role: "manager", team: "Customer Success" },
  { email: "tom@insurecrm.com", password: "demo123", name: "Tom Chen", role: "agent", team: "Support Engineering" },
  { email: "lisa@insurecrm.com", password: "demo123", name: "Lisa Park", role: "agent", team: "Support Engineering" },
  { email: "david@insurecrm.com", password: "demo123", name: "David Kim", role: "agent", team: "Billing & Accounts" },
  { email: "rachel@insurecrm.com", password: "demo123", name: "Rachel Green", role: "agent", team: "Customer Success" },
  { email: "mike@insurecrm.com", password: "demo123", name: "Mike Davis", role: "agent", team: "Support Engineering" },
  { email: "viewer@insurecrm.com", password: "demo123", name: "Jordan Lee", role: "viewer", team: null },
];
...
const demoKnowledgeArticles = [
  ...
  { title: "Understanding Your Invoice and Billing Cycle", content: "Invoices are generated on the 1st of each month for the previous month's usage. You can view and download invoices from Settings > Billing > Invoice History. Your plan charges include the base subscription plus any overage fees for tickets beyond your plan limit. Payments are automatically processed using the card on file. To update your payment method, go to Settings > Billing > Payment Methods.", collection: "Account & Billing", status: "published", views: 2103, ai_used: 156, helpful: 88, tags: ["billing", "invoice", "payment", "subscription"] },
   { title: "How to Upgrade or Downgrade Your Plan", content: "To change your plan, go to Settings > Billing > Subscription. Click 'Change Plan' and select your desired tier. Upgrades take effect immediately and you'll be charged a prorated amount. Downgrades take effect at the end of your current billing cycle. All plan features are listed on our pricing page. Contact sales@insurecrm.com for Enterprise custom plans.", collection: "Account & Billing", status: "published", views: 1567, ai_used: 112, helpful: 90, tags: ["plan", "upgrade", "downgrade", "subscription", "pricing"] },
  { title: "Requesting a Refund", content: "We offer refunds within 14 days of purchase if you're unsatisfied. To request a refund, email billing@insurecrm.com with your account email, invoice number, and reason for the refund. Refunds are processed within 5-7 business days to your original payment method. Note: refunds are not available for partial month usage after the 14-day window.", collection: "Account & Billing", status: "published", views: 743, ai_used: 54, helpful: 85, tags: ["refund", "billing", "money-back"] },
  ...
  { title: "Setting Up Email Integration (IMAP/SMTP)", content: "Navigate to Settings > Channels > Email Integration. Enter your IMAP server details (host, port, username, password) for receiving emails, and SMTP details for sending. Common configurations: Gmail (imap.gmail.com:993), Outlook (outlook.office365.com:993). Enable SSL/TLS for secure connections. After setup, emails will automatically appear in your inbox and can be classified by AI agents.", collection: "Integrations", status: "published", views: 2876, ai_used: 198, helpful: 89, tags: ["email", "imap", "smtp", "integration"] },
   { title: "Configuring the Web Chat Widget", content: "Embed the chat widget on your website by adding a single script tag to your HTML: <script src='https://cdn.insurecrm.com/chat-widget.js' data-key='YOUR_KEY'></script>. Customize the widget appearance in Settings > Channels > Web Chat. You can change colors, position, welcome message, and pre-chat form fields. The widget supports mobile responsive design and agent handoff.", collection: "Integrations", status: "published", views: 1987, ai_used: 143, helpful: 93, tags: ["webchat", "widget", "embed", "integration"] },
  { title: "Integrating Facebook Messenger", content: "Connect your Facebook Page to InsureCRM via Settings > Channels > Facebook Messenger. You'll need to authenticate with your Facebook account and select the page you want to connect. Messenger conversations will appear in your unified inbox alongside other channels. AI agents can respond to Messenger inquiries automatically using your knowledge base.", collection: "Integrations", status: "published", views: 1654, ai_used: 121, helpful: 87, tags: ["messenger", "facebook", "integration"] },
  ...
  { title: "Mobile App Crashes and Performance", content: "For mobile app issues: 1) Ensure you're on the latest version. 2) Clear app cache (Settings > Storage > Clear Cache). 3) Check device compatibility (iOS 15+ / Android 10+). 4) Restart the app. 5) If crashes persist, reinstall the app. For iOS photo upload crashes, this is a known issue on iOS 17.2 - update to 17.3+ for the fix. Report persistent issues via the in-app feedback form.", collection: "Troubleshooting", status: "published", views: 1543, ai_used: 112, helpful: 83, tags: ["mobile", "crash", "performance", "troubleshooting"] },
   { title: "Understanding Sentiment Analysis", content: "InsureCRM's sentiment agent analyzes every message in real-time, detecting emotions like positive, neutral, negative, angry, and frustrated. Sentiment scores range from -1 (very negative) to +1 (very positive). The system uses natural language processing trained on customer support data. Sentiment trends are tracked over time to identify patterns. Use sentiment data to prioritize at-risk customers and improve response strategies.", collection: "Technical Docs", status: "published", views: 2345, ai_used: 189, helpful: 91, tags: ["sentiment", "ai", "analysis", "nlp"] },
  { title: "REST API Documentation Overview", content: "InsureCRM provides a comprehensive REST API for programmatic access. Base URL: https://api.insurecrm.com/v1. Authentication: Bearer token in Authorization header. Key endpoints: /tickets (CRUD), /customers (CRUD), /knowledge (search), /analytics (reports). Rate limits: 1000 requests/minute. Full documentation at docs.insurecrm.com/api. SDKs available for Node.js, Python, PHP, and Go.", collection: "API Reference", status: "published", views: 4567, ai_used: 345, helpful: 93, tags: ["api", "rest", "documentation", "developers"] },
  { title: "Webhook Configuration Guide", content: "Set up webhooks in Settings > API > Webhooks. Available events: ticket.created, ticket.updated, ticket.escalated, message.received, sentiment.changed. Payload includes event type, timestamp, and full resource data. Configure retry logic (3 attempts with exponential backoff). Verify webhook signatures using your webhook secret. Test webhooks with the built-in test tool.", collection: "API Reference", status: "published", views: 1876, ai_used: 134, helpful: 89, tags: ["webhook", "api", "events", "integration"] },
   { title: "Data Export and Privacy Compliance", content: "InsureCRM is GDPR and NDPR compliant. Export your data anytime from Settings > Data > Export. Available formats: CSV, JSON, XML. Exports include tickets, customers, conversations, and analytics. Data retention: 90 days for messages, 1 year for tickets, indefinite for knowledge base. To request data deletion, email privacy@insurecrm.com. Audit logs track all data access.", collection: "Technical Docs", status: "published", views: 1234, ai_used: 89, helpful: 90, tags: ["gdpr", "privacy", "data", "compliance", "export"] },
...
export async function POST() {
  try {
    ...
    for (let i = 0; i < demoTickets.length; i++) {
      ...
      const assigneeId = userIdMap["tom@insurecrm.com"];
    ...
    const adminUserId = userIdMap["admin@insurecrm.com"];
    ...
    return NextResponse.json({
      ...
      logins: {
        admin: "admin@insurecrm.com / admin123",
        manager: "sarah@insurecrm.com / demo123",
        agent: "tom@insurecrm.com / demo123",
        viewer: "viewer@insurecrm.com / demo123",
      },
    });
  } catch (error) {
