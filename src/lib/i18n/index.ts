...
export const translations = {
  ...
  meetAI: {
    label: { en: "Meet Insure AI", fr: "Découvrez Insure AI" },
    title: { en: "The intelligence layer behind every decision", fr: "La couche d'intelligence derrière chaque décision" },
    desc: {
      en: "Insure AI is the engine InsureCRM is built on. Trained on real support signals — it classifies, routes, monitors, and resolves so your team can focus on complex issues.",
      fr: "Insure AI est le moteur sur lequel InsureCRM est construit. Entraîné sur de vrais signaux de support — il classe, route, surveille et résout pour que votre équipe puisse se concentrer sur les problèmes complexes.",
    },
  },
  security: {
    ...
    desc: {
      en: "InsureCRM is built to meet data protection, financial regulation, and compliance requirements of insurance companies, banks, and institutions globally.",
      fr: "InsureCRM est conçu pour répondre aux exigences de protection des données, de réglementation financière et de conformité des compagnies d'assurance, banques et institutions du monde entier.",
    },
  },
  integrations: {
    ...
    desc: {
      en: "Connect InsureCRM to your existing tools in minutes — communication channels, automation platforms, cloud services, and CRMs. No rip-and-replace.",
      fr: "Connectez InsureCRM à vos outils existants en quelques minutes — canaux de communication, plateformes d'automatisation, services cloud et CRM. Pas de remplacement.",
    },
    apiCta: { en: "Explore the API", fr: "Explorer l'API" },
    noTool: { en: "Don't see your tool? InsureCRM exposes a full REST API — connect anything in your stack.", fr: "Vous ne voyez pas votre outil? InsureCRM expose une API REST complète — connectez n'importe quoi dans votre pile." },
  },
  cta: {
    ...
    desc: { en: "Every ticket is a promise. InsureCRM makes sure you keep it.", fr: "Chaque ticket est une promesse. InsureCRM s'assure que vous la tenez." },
  ...
  channelsPage: {
    ...
    developer: {
      ...
      desc: { en: "InsureCRM provides a clean, intuitive API that makes channel integration effortless. One endpoint per channel, consistent response formats, and comprehensive documentation.", fr: "InsureCRM fournit une API propre et intuitive qui rend l'intégration des canaux sans effort. Un endpoint par canal, formats de réponse cohérents et documentation complète." },
  ...
  aboutPage: {
    title: { en: "About InsureCRM", fr: "À propos d'InsureCRM" },
    ...
    mission: {
      ...
      desc: { en: "InsureCRM empowers insurance businesses to deliver exceptional customer experiences through intelligent automation. We believe every customer interaction is an opportunity to build trust, and AI is the key to making that happen at scale.", fr: "InsureCRM permet aux entreprises d'assurance d'offrir des expériences client exceptionnelles grâce à l'automatisation intelligente. Nous croyons que chaque interaction client est une occasion de bâtir la confiance." },
    },
    values: {
    ...
    story: {
      ...
      p1: { en: "Founded in Nigeria, InsureCRM was born from the frustration of managing insurance customer support across too many channels. We watched insurance businesses struggle with fragmented tools, missed tickets, and unhappy customers.", fr: "Fondée au Nigéria, InsureCRM est née de la frustration de gérer le support client d'assurance sur trop de canaux. Nous avons vu des entreprises lutter avec des outils fragmentés." },
      p2: { en: "We built the platform we wished existed — a single place where AI handles the repetitive work, agents focus on what matters, and no customer ever feels ignored. Today, InsureCRM powers support for hundreds of insurance teams across Africa and beyond.", fr: "Nous avons construit la plateforme que nous aurions aimé voir exister — un endroit où l'IA gère le travail répétitif et aucun client ne se sent jamais ignoré." },
    ...
    numbers: {
      ...
      teams: { en: "Teams Using InsureCRM", fr: "Équipes utilisant InsureCRM" },
  ...
  landing: {
    ...
    steps: {
      ...
      classify: { title: { en: "Classify", fr: "Classification" }, desc: { en: "Insure AI detects intent, sentiment, and urgency in under 50ms. Routes to the right queue.", fr: "Insure IA détecte l'intention, le sentiment et l'urgence en moins de 50ms. Route vers la bonne file." } },
  ...
  misc: {
    poweredBy: { en: "InsureCRM-powered delivery", fr: "Livraison propulsée par InsureCRM" },
  ...
  footer: {
    desc: { en: "AI-powered insurance support platform. Built by InsureCRM for teams that move fast.", fr: "Plateforme de support client d'assurance alimentée par l'IA. Construite par InsureCRM pour les équipes qui avancent vite." },
    ...
    copyright: { en: "© 2026 InsureCRM. All rights reserved.", fr: "© 2026 InsureCRM. Tous droits réservés." },
  },
  loginPage: {
    ...
    testimonial: { en: "InsureCRM cut our response time by 73% and our team can focus on complex issues instead of repetitive questions.", fr: "InsureCRM a réduit notre temps de réponse de 73% et notre équipe peut se concentrer sur les problèmes complexes." },
    testimonialRole: { en: "Head of Support, InsureCRM", fr: "Directeur du Support, InsureCRM" },
  ...
  dashboardPage: {
    ...
    welcomeBack: { en: "Welcome back, {name}. Here's your InsureCRM support overview.", fr: "Bon retour, {name}. Voici votre aperçu du support InsureCRM." },
    export: { en: "Export", fr: "Exporter" },
