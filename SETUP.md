# InsureCRM Deployment Setup Guide

## URLs
- **Production**: https://insurecrm-rho.vercel.app
- **Login**: https://insurecrm-rho.vercel.app/login

## Demo Credentials
| Role | Email | Password |
|------|-------|----------|
| Super Admin | adewale@insurecrm.com | admin123 |
...
- **Seed endpoint**: POST https://insurecrm-rho.vercel.app/api/seed

## WhatsApp Webhook Setup
1. Go to https://developers.facebook.com/app/1559122952241901/webhooks
2. Add webhook URL: `https://insurecrm-rho.vercel.app/api/webhooks/whatsapp`
...
```
https://insurecrm-rho.vercel.app/api/webhooks/email
```

### Termii SMS Setup
- **API Key**: Set in Vercel env vars as TERMII_API_KEY
- **Sender ID**: Set in Vercel env vars as TERMII_SENDER_ID
- **Inbound SMS URL**: `https://insurecrm-rho.vercel.app/api/webhooks/sms`
...
- **Landing page**: Insurance-focused hero, features, and CTAs
- **Knowledge base**: 30 insurance articles
- **Demo customers**: Nigerian insurance companies
- **Ticket prefix**: INS-
